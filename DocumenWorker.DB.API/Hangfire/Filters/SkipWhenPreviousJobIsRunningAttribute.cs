...
namespace DocumenWorker.DB.API.Hangfire.Filters
{
    /// <summary>
    /// Атрибут для хенгфаере, который отвечает за то, чтобы джоба не запускалась повторно, если эта джоба в процессе
    /// </summary>
